...
\noindent The total workshop fee of \textbf{\Sexpr{work_fee}} should be paid by bank transfer to the \textbf{JULY 15, 2016}. Please remember that the transfer \textit{should be done} to the deadline, otherwise your place at workshop will be given to the next person from a reserve list. 

Please only pay for the workshops in which you are listed on a regular list. If you are in workshops on a reserve list please wait for the information about free spaces. Details of the bank account are provided below.
