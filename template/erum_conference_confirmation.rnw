...
The eRum 2016 Organizing Committee is pleased to inform you that your paper \textbf{\Sexpr{pres_title}} has been selected for the eRum 2016 Conference. The organizing committee have decided that your paper have been selected as \textbf{\Sexpr{type}}. The conference program is now being prepared and will be published on the conference webpage in the begining of September. 

\noindent The conference fee of 100 PLN / 25 EUR should be paid by bank transfer to the \textbf{JULY 15, 2016}. Please remember that after this date the conference fee is 150 PLN / 35 EUR. Details of are provided below.
