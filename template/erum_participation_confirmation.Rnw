...
\noindent Registration fee of 100 PLN / 20 EUR should be paid by bank transfer to the \textbf{JUNE 15, 2016}. Details of are provided below.
...
\item \textbf{Transfer title}: "Fee for \Sexpr{name} \Sexpr{surname} (\Sexpr{inst})"
\end{itemize}
