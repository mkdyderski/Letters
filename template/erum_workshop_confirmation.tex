...
\documentclass[10pt,a4paper]{letter}\usepackage[]{graphicx}\usepackage[]{color}
...
\usepackage{alltt} % Specify the font size (10pt, 11pt and 12pt) and paper size (letterpaper, a4paper, etc)
...
\usepackage[pdftex,
            pdfauthor={Adam Student},
            pdftitle={EUROPEAN R USERS MEETING},
            pdfsubject={some-mail@domain.com}]{hyperref}
